...
namespace ScriptableArchitect.Variables
{
    ...
    /// </summary>
    [System.Serializable]
    public class AudioClipArrayReference
    {
        ...
        public AudioClipArrayVariable Variable;
        /// <summary>
        /// Default constructor.
        /// </summary>
        ...
        public AudioClipArrayReference(AudioClip[] value)
        {
            UseConstant = true;
            ConstantValue = value;
        }
        ...
        public static implicit operator AudioClip[](AudioClipArrayReference reference)
        {
